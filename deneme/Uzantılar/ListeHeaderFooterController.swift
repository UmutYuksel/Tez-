...
open class ListeHeaderFooterController <T : ListeCell<U> , U, H : UICollectionReusableView, F:UICollectionReusableView> : UICollectionViewController {
    ...
    func setCellHeight(indexPath : IndexPath, cellGenislik : CGFloat) -> CGFloat {
    ...
    public init(scroolYonu : UICollectionView.ScrollDirection = .vertical) {
        let layout = UICollectionViewFlowLayout()
        layout.scrollDirection = scroolYonu
